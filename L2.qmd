...
hist(tempo[,-1], ylab = "Frequência", main = "Histograma", xlab = "X")

qqnorm(tempo[,-1], xlab = "Quantis normais", ylab = "X")
...
Contagem: 5, 1, 3, 1, 2, 18, 20, 4, 15, 2, 4\   
Custo: 50, 150, 50, 10, 20, 180, 200, 10, 5, 20, 150
